...
public class Jedis extends BinaryJedis implements JedisCommands, MultiKeyCommands,
    AdvancedJedisCommands, ScriptingCommands, BasicCommands, ClusterCommands, SentinelCommands, ModuleCommands, TSDBCommands {
  ...
  public byte[] bde(final String key) {
    checkIsInMultiOrPipeline();
    client.bde(key);
  ...
  public Long hstrlen(String key, String field) {
	...
	@Override
	public Long tadd(String key, Map<Long, Double> tvPair) {
		checkIsInMultiOrPipeline();
